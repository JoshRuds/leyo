...
const Error errorTable[] = {
    ...
    {ERR_VM_OVERFLOW,                    "V002", "Instruction pointer overflowed.", .fatal=true},
    {ERR_VM_INVALID_BINARY_OP,           "V003", "Invalid binary operation", .fatal=true},
    {ERR_VM_CANNOT_DECODE_CONST_POOL,    "V004", "Failed to decode constant pool", .fatal=true},
    {ERR_VM_CANNOT_ALLOCATE,             "V005", "Virtual machine out of memory", .fatal=true},
    {ERR_VM_INVALID_CONST_POOL,          "V006", "Invalid constant pool", .fatal=true},
    {ERR_VM_INVALID_JUMP,                "V007", "Invalid jump target", .fatal=true},
    {ERR_VM_GLOBAL_SLOT_OUT_OF_RANGE,    "V008", "Global slot out of range", .fatal=true},
    {ERR_VM_CONST_OUT_OF_RANGE,          "V009", "Constant index out of range", .fatal=true},
    {ERR_VM_UNKOWN_NATIVE_COMMAND,       "V010", "Unknown native command", .fatal=true},
    {ERR_VM_TEXT_NUM_TYPE_CALC,          "V011", "Cannot perform arithmetic between text and number", .fatal=false},
    {ERR_VM_TEXT_CALC_UNSUPPORTED,       "V012", "Text arithmetic is unsupported", .fatal=false},
    {ERR_VM_UNEXPECTED_EXIT,             "V013", "Program exited unexpectedly", .fatal=true},
